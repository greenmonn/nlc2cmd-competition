...
def makeheredoc(tokenizer, redirnode, lineno, killleading):
    ...
    if not fullline:
        raise errors.ParsingError("here-document at line %d delimited by end-of-file (wanted %r)" % (
            lineno, redirword), tokenizer._shell_input_line, tokenizer._shell_input_line_index)
