...
def string_match(ast1, ast2):
    str1 = data_tools.ast2template(
        ast1, loose_constraints=True, arg_type_only=False)
    str2 = data_tools.ast2template(
        ast2, loose_constraints=True, arg_type_only=False)
    return str1 == str2


if __name__ == '__main__':
    asts = [data_tools.bash_parser(
        'find . -type f -print0 | xargs -0 -I {} grep -i -l __SP__UNK {}')]
    ast = data_tools.bash_parser(
        'find . -type f -print0 | xargs -0 -I {} grep -i -l \'.*\' {}')
